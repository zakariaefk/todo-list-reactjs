  ...
  return (
    <div className='todos-form'>
        ...
        <div className='todos-form_form'>
            <input type='text' placeholder='Add new task' onChange={newTitleHandler} value={newTitle}/>
        </div>
        <div className='todos-form_submit'>
            <button className='btn' onClick={addNewTodoHandler} disabled={newTitle.trim() ? false : true}>
              {btnString}
            </button>
        </div>
    </div>
